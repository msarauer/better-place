...
import { addOpportunity, rowFilter, updateRows } from "../helpers/filters-and-sorters";
...
const OpportunityList = ({
  ...
  const addVolunteer = (opportunityId) => {
    const newRows = addOpportunity(rows, opportunityId);
    setRows(newRows);
    axios.put(`/api/opportunity/add/${opportunityId}`);
    console.log("workinggggg");
  };

  const removeVolunteer = (opportunityId) => {
    axios.put(`/api/opportunity/remove/${opportunityId}`);
  };
      ...
      <List
        ...
        renderItem={(item) => (
          ...
          >
            ...
            <br/>
            {!item.selected &&
            <Switch checkedChildren="Volunteering" unCheckedChildren="Volunteer" onChange={onChange} />
            }
            {item.selected &&
